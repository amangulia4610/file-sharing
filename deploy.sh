...
# Deployment script for File Sharing App
...
echo "2. Deploy server to Render.com (see DEPLOYMENT_GUIDE.md)"
echo "3. Update client/src/config.js with your server URL"
